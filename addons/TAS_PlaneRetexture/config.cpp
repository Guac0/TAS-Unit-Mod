...
class CfgVehicles
{
	...
	class TAS_A164_Ahegao: B_Plane_CAS_01_dynamicLoadout_F
	{
		author = "Guac";
		displayName = "Ahegao A-164";
		scope = 2;
		scopecurator = 2;
		...
		hiddenSelectionsTextures[] = {"Autismo_Seals_Unit_Mod\addons\TAS_PlaneRetexture\Data\a164_ahegao_ext01_CO.paa", "Autismo_Seals_Unit_Mod\addons\TAS_PlaneRetexture\Data\a164_ahegao_ext02_CO.paa"};
	};
