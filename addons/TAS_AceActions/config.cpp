		...
		class ACE_SelfActions {
			class ACE_Equipment {
				class TAS_MineSign {
					...
					exceptions[] = {};
					statement = "ACE_player playActionNow 'medic'; [6, [], {_obj = createVehicle ['Land_Sign_Mines_F', position ACE_player, [], 0, 'CAN_COLLIDE']; [_obj, true, [0, 2, 0], 0] remoteExecCall ['ace_dragging_fnc_setCarryable']; [ace_player,_obj] call ace_dragging_fnc_carryObject; }, {ACE_player playActionNow 'medicstop';}, 'Unfolding sign...'] call ace_common_fnc_progressBar"; //start dragging after deployed. //ACE_player switchMove ''; //to get unstuck
				...
				class TAS_DigFoxhole {
					...
					exceptions[] = {};
					statement = "ACE_player playActionNow 'medic'; [10, [], {_obj = createVehicle ['vurtual_foxhole', position ACE_player, [], 0, 'CAN_COLLIDE']; _obj enableSimulationGlobal true;}, {ACE_player playActionNow 'medicstop';}, 'Digging Foxhole...'] call ace_common_fnc_progressBar";
					//icon = ""; //might add a custom icon later, for now let's see what default looks like
				};
			};
		};
