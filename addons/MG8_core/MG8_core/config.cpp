////////////////////////////////////////////////////////////////////
//DeRap: MG8_core\config.bin
//Produced from mikero's Dos Tools Dll version 8.35
//https://mikero.bytex.digital/Downloads
//'now' is Fri Jul 15 17:36:50 2022 : 'file' last modified on Wed Dec 31 19:00:01 1969
////////////////////////////////////////////////////////////////////
...
class CfgPatches
{
	class MG8_core
	{
		...
		units[] = {"B_Plane_CAS_01_F","B_Plane_CAS_01_dynamicLoadout_F"};
		weapons[] = {"Gatling_30mm_Plane_CAS_01_F"};
		requiredVersion = 1.7;
		requiredAddons[] = {"A3_Weapons_F","A3_Air_F","A3_Air_F_EPC","A3_Air_F_EPC_Plane_CAS_01"};
		author = "Zabuza";
		authors[] = {"Zabuza"};
	};
};
...
class CfgVehicles
{
	...
	{
		magazines[] = {"MG8_1174Rnd_Gau8_30mm","2Rnd_Missile_AA_04_F","6Rnd_Missile_AGM_02_F","4Rnd_Bomb_04_F","7Rnd_Rocket_04_HE_F","7Rnd_Rocket_04_AP_F","Laserbatteries","240Rnd_CMFlare_Chaff_Magazine"};
	};
...
class CfgCloudlets
{
	...
	class MG8_ShellSmkCldlt: MG8_DefaultCldlt
	{
		...
		color[] = {{0.3,0.3,0.3,0.7},{0.5,0.5,0.5,0.4},{0.5,0.5,0.5,0.22},{0.6,0.6,0.6,0.09},{0.8,0.8,0.8,0.01}};
		colorVar[] = {0,0,0,0.4};
		interval = 0.003;
		lifeTime = 4;
		lifeTimeVar = 1.5;
...
class CfgSoundSets
{
	class MG8_Gau8_Exp_SoundSet
	{
		...
		soundShaders[] = {"MG8_Gau8_Close_Exp_SoundShader","MG8_Gau8_Distant_Exp_SoundShader","MG8_Gau8_Far_Exp_SoundShader"};
		spatial = 1;
		speedOfSound = 1;
...
class CfgSoundShaders
{
	...
	{
		range = 300;
		rangeCurve[] = {{0,1},{50,1},{70,0.8},{150,0.8},{299.5,0.7},{300,0}};
		samples[] = {{"\MG8_core\sounds\ammo\Gau8_ground_impact_close1",1},{"\MG8_core\sounds\ammo\Gau8_ground_impact_close2",1}};
		volume = 1;
	};
	class MG8_Gau8_Distant_Exp_SoundShader
	{
		range = 600;
		rangeCurve[] = {{0,0},{299.5,0},{300,0.8},{599.5,0.5},{600,0}};
		samples[] = {{"\MG8_core\sounds\ammo\Gau8_ground_impact_distant1",1},{"\MG8_core\sounds\ammo\Gau8_ground_impact_distant2",1}};
		volume = 1;
	};
	class MG8_Gau8_Far_Exp_SoundShader
	{
		range = 1500;
		rangeCurve[] = {{0,0},{599.5,0},{600,0.8},{1499.5,0.5},{1500,0}};
		samples[] = {{"\MG8_core\sounds\ammo\Gau8_ground_impact_far1",1},{"\MG8_core\sounds\ammo\Gau8_ground_impact_far2",1}};
		volume = 1;
	};
};
class CfgSoundCurves
{
	...
	{
		points[] = {{0,1},{0.002,0.98},{0.007,0.9},{0.1,0.8},{0.8,0.1},{0.9,0.05},{1,0}};
	};
};
