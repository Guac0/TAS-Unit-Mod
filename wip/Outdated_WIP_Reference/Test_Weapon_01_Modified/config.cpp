...
class CfgWeapons
{
	...
	{
		magazines[] = {30Rnd_test_mag_Tracer, 10Rnd_test_mag, 30Rnd_test_mag, test_mag_group}; /// original custom made magazines and a group of several standardized mags
...
//caseless ammo//
	...
	class Test_weapon_01_F: Test_weapon_01_Base_F
	{
		...
		model = "Test_weapon_01\test_weapon_01_F.p3d"; /// path to model

		picture = "Test_weapon_01\Data\UI\gear_test_weapon_01_X_CA.paa"; /// different accessories have M, S, T instead of X
